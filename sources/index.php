...
$about = $db->rawQueryOne("select hienthi,ten_$lang as ten,mota_$lang as mota,photo,slogan1_$lang as slogan1,slogan2_$lang as slogan2 from #_info where type=? limit 0,1", array('gioi-thieu'));

$taisaochon = $db->rawQueryOne("select hienthi,ten_$lang as ten,mota_$lang as mota,photo,slogan1_$lang as slogan1,slogan2_$lang as slogan2 from #_info where type=? limit 0,1", array('tai-sao'));
