...
<form name="supplier" class="form" action="index.html?com=setting&act=save" method="post" enctype="multipart/form-data"
        ...
        <div class="widget mtop0">
            ...
            <div class="formRow">
                ...
                <div class="formRight">
                    ...
                    <input type="text" value="<?=@$timeSlider?>" name="data[time_slider]" title="Nhập địa chỉ link blog"
                        class="conso tipS" />
            ...
            <?php if($GLOBAL[$com]['title_page']==true) {?>

            <div class="formRow">

                <label>Tiêu đề sản phẩm tháng</label>

                <div class="formRight">

                    <input type="text" value="<?=@$item['title_page']?>" name="data[title_page]" title="Nhập tiêu đề"
                        class="tipS" />
            ...
            <?php if($GLOBAL[$com]['link_blog']==true) {?>
            ...
            <div class="formRow">
                ...
                <div class="formRight">
                    ...
                    <input type="text" value="<?=@$item['link_blog']?>" name="data[link_blog]"
                        title="Nhập địa chỉ link blog" class="tipS" />
            ...
            <div class="formRow ">
                ...
                <div class="formRight">
                    ...
                    <input type="text" name="data[chuky]" title="Nhập Chữ Ký" id="chuky" class="tipS"
                        value="<?=@$item['chuky']?>" />
            ...
            <div class="formRow">
                ...
                <div class="formRight">
                    ...
                    <input type="text" value="<?=@$item['website']?>" name="data[website]" title="Nhập địa chỉ website"
                        class="tipS" />
    ...
    <div class="formRow">
        ...
        <div class="formRight">
            ...
            <input type="text" name="data[page_in]" title="Nhập số item sản phẩm" id="page_in" class="tipS"
                value="<?=@$item['page_in']?>" />
    ...
    <div class="formRow">
        ...
        <div class="formRight">
            ...
            <input type="text" name="data[page_sp]" title="Nhập số item sản phẩm" id="page_sp" class="tipS"
                value="<?=@$item['page_sp']?>" />
    ...
    <?php if($GLOBAL[$com]['page_sp_m']==true) {?>

    <div class="formRow">

        <label>Phân trang sản phẩm mobile</label>

        <div class="formRight">

            <input type="text" name="data[page_sp_m]" title="Nhập số item sản phẩm" id="page_sp_m" class="tipS"
                value="<?=@$item['page_sp_m']?>" />
    ...
    <div class="formRow">
        ...
        <div class="formRight">
            ...
            <input type="text" name="data[limit_sp]" title="Nhập số sản phẩm ở trang chủ" id="limit_sp" class="tipS"
                value="<?=@$item['limit_sp']?>" />
    ...
    <div class="formRow">
        ...
        <div class="formRight">
            ...
            <input type="text" name="data[page_ne]" title="Nhập số item sản phẩm" id="page_ne" class="tipS"
                value="<?=@$item['page_ne']?>" />
    ...
    <div class="formRow">
        ...
        <div class="formRight">
            ...
            <input type="text" name="data[page_video]" title="Nhập số item sản phẩm" id="page_video" class="tipS"
    ...
    <div class="formRow">
        ...
        <div class="formRight">
            ...
            <input type="text" name="data[page_album]" title="Nhập số item sản phẩm" id="page_album" class="tipS"
    ...
    <div class="formRow">
        ...
        <div class="formRight">
            ...
            <input type="text" name="data[page_service]" title="Nhập số item sản phẩm" id="page_service" class="tipS"
    ...
    <?php if($GLOBAL[$com]['page_new']==true) {?>
    ...
    <div class="formRow">
        ...
        <div class="formRight">
            ...
            <input type="text" name="data[page_new]" title="Nhập số item sản phẩm" id="page_new" class="tipS"
                value="<?=@$item['page_new']?>" />
    ...
    <div class="formRow">
        ...
        <label for="check1" style="float: left; display: inline-block; width: auto !important; margin-right: 10px;">Khóa
    ...
    <div class="formRow">
        ...
        <div class="formRight">
            ...
            <input type="text" name="data[phivanchuyen]" title="Phí vận chuyển" id="phivanchuyen" class="conso tipS"
                value="<?=@$item['phivanchuyen']?>" />
    ...
    <div class="formRow">
        ...
        <div class="formRight">
            ...
            <div class="mt10 change-photo">
                ...
                <span style="color:blue;display:block;font-size:16px;" class="mt20"><span style="color:#000;">Tên tệp
    ...
    <div class="formRow">
        <label>Hình đóng dấu : <span style="color:#f00">(max-width:302px-max-height:302px)</span></label>
    ...
    <div class="widget mtop10">
        ...
        <div class="formRow">
            ...
            <div class="formRight">
                ...
                <input type="text" value="<?=@$item['blank']?>" name="data[blank]" title="Nhập tax code" class="tipS" />
        ...
        <div class="formRow">
            ...
            <div class="formRight">
                ...
                <input type="text" value="<?=@$item['city']?>" name="data[city]" title="Nhập thành phố" class="tipS" />
    ...
    <div class="widget mtop10">
        ...
        <div class="formRow">
            ...
            <div class="formRight">
                ...
                <textarea data-validation="required" data-validation-error-msg="Description trang không được để trống"
