    ...
    <div class="control_frm">
        <div class="bc">
            <ul id="breadcrumbs" class="breadcrumbs">
                <li><a
                        href="index.html?com=booking&act=add<?php if($_GET['type']!='') echo'&type='. $_GET['type'];?>"><span>Đăng ký tư vấn</span></a></li>
        ...
        <div class="oneOne">
            <div class="widget mtop0">
                ...
                <?php if($GLOBAL[$com][$type]['product']==true){
                    $name_product=$db->rawQueryOne("select ten_$lang as ten from #_baiviet where id=? limit 1",[$item['id_product']]);        
                ?>
                <div class="formRow">
                    <label>Tên sản phẩm</label>
                    <div class="formRight">
                        <input type="text" name="data[ten_vi]" title="Họ tên" id="ten_vi"
                            class="tipS validate[required]" value="<?=@$name_product['ten']?>" />
                    </div>
                    <div class="clear"></div>
                </div>
                <?php }?>
