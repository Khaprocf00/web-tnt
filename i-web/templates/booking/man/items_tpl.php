                ...
                <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <?php if($GLOBAL[$com][$type]['product']==true){
                                $name_product=$db->rawQueryOne("select ten_$lang as ten from #_baiviet where id=? limit 1",[$items[$i]['id_product']]);    
                            ?>
                            ...
                            <?php if($GLOBAL[$com][$type]['id_product']==true){
                                    $tensanpham = $db->rawQueryOne("select ten_$lang as ten from #_baiviet where type=? and id=? limit 0,1",array('dich-vu',$items[$i]["id_dichvu"]));
