        ...
        <div class="oneOne">
            <div class="widget mtop0">
                ...
                <div class="formRow lang_hidden lang_<?=$k?> <?= ($k == 'vi') ? 'active': '' ?>">
                    ...
                    <div class="formRight">
                        <input type="text" name="data[ten_<?=$k?>]" title="Nhập tên" id="ten_<?=$k?>"
                ...
                <div class="formRow lang_hidden lang_<?=$k?> <?= ($k == 'vi') ? 'active': '' ?>">
                    ...
                    <div class="formRight">
                        <input type="text" id="slogan_<?=$k?>" name="data[slogan_<?=$k?>]"
                            value="<?=@$item['slogan_'.$k]?>" title="Nhập link liên kết cho hình ảnh" class="tipS" />
                    </div>
                    <div class="clear"></div>
                </div>
                <?php } ?>
                ...
                <div class="formRow lang_hidden lang_<?=$k?> <?= ($k == 'vi') ? 'active': '' ?>">
                    <label>Number</label>
                    <div class="formRight">
                        <input type="text" data-validation="required" data-validation-error-msg="Số không được bỏ trống"
                            name="data[number]" title="Nhập tên danh mục" id="number"
                ...
                <div class="formRow">
                    ...
                    <div class="formRight">
                        <input type="text" id="code_pro" name="data[linh_vuc]" value="<?=$item["linh_vuc"]?>"
                ...
                <div class="formRow">
                    <label>Năm:</label>
                    <div class="formRight">
                        <input type="text" id="code_pro" name="data[nam]" value="<?=$item["nam"]?>"
                            title="Nhập link liên kết cho hình ảnh" class="tipS" />
                    </div>
                    <div class="clear"></div>
                </div>
                ...
                <div class="formRow">
                    ...
                    <div class="formRight">
                        <input data-validation="required" data-validation-error-msg="điện thoại không được để trống"
                            type="text" id="code_pro" name="data[phone]" value="<?=$item["phone"]?>"
                ...
                <div class="formRow">
                    <label><?=_links?>: </label>
                    <div class="formRight">
                        <input type="text" id="price" name="data[link]" value="<?=@$item['link']?>"
                            title="Nhập link liên kết cho hình ảnh" class="tipS" />
                    </div>
                    <div class="clear"></div>
                </div>
                ...
                <div class="formRow">
                    ...
                    <div class="formRight">
                        <input type="text" id="price" name="data[link_temp]" value="<?=@$item['link_temp']?>"
                            title="Nhập link_temp liên kết cho hình ảnh" class="tipS" />
                    </div>
                    <div class="clear"></div>
                </div>
                <?php } ?>
