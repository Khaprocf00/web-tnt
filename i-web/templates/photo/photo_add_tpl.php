...
<div class="control_frm">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
            <li><a href="index.html?com=photo&act=man<?php if ($_GET['type'] != '') echo '&type=' . $_GET['type']; ?><?php if ($_GET['page'] != '') echo '&page=' . $_GET['page']; ?>"><span><?= $GLOBAL[$com][$type]['title'] ?></span></a>
            </li>
...
<form name="supplier" class="form form-validate" action="index.html?com=photo&act=save<?php if ($_GET['type'] != '') echo '&type=' . $_GET['type']; ?><?php if ($_GET['page'] != '') echo '&page=' . $_GET['page']; ?>" method="post" enctype="multipart/form-data" autocomplete="off" accept-charset="utf-8">
    <div class="mtop0">
        <div class="oneOne">
            ...
            <div class="widget mtop0">
                <?php foreach ($config['lang'] as $k => $v) { ?>
                    ...
                    <?php if ($GLOBAL[$com][$type]['slogan'] == true) { ?>
                        <div class="formRow lang_hidden lang_<?= $k ?> <?= ($k == 'vi') ? 'active' : '' ?>">
                            ...
                            <div class="formRight">
                                <input type="text" id="slogan_<?= $k ?>" name="data[slogan_<?= $k ?>]" value="" title="Nhập link liên kết cho hình ảnh" class="tipS" />
                            </div>
                            <div class="clear"></div>
                        </div>
                    <?php } ?>
                ...
                <?php if ($GLOBAL[$com][$type]['phone'] == true) { ?>
                    <div class="formRow lang_hidden lang_<?= $k ?> <?= ($k == 'vi') ? 'active' : '' ?>">
                        ...
                        <div class="formRight">
                            <input type="text" data-validation="required" data-validation-error-msg="Số điện thoại không được bỏ trống" name="data[phone]" title="Nhập phone" id="phone" class="tipS validate[required]" value="<?= @$item['phone'] ?>" />
                        </div>
                        <div class="clear"></div>
                    </div>
                <?php } ?>
                ...
                <?php if ($GLOBAL[$com][$type]['linhvuc'] == true) { ?>
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            <input type="text" id="code_pro" name="data[linh_vuc]" value="" title="Nhập link liên kết cho hình ảnh" class="tipS" />
                        </div>
                        <div class="clear"></div>
                    </div>
                <?php } ?>
                ...
                <?php if ($GLOBAL[$com][$type]['nam'] == true) { ?>
                    <div class="formRow">
                        <label>Năm:</label>
                        <div class="formRight">
                            <input type="text" id="code_pro" name="data[nam]" value="" title="Nhập link liên kết cho hình ảnh" class="tipS" />
                        </div>
                        <div class="clear"></div>
                    </div>
                <?php } ?>
                    ...
                    <div class="formRow">
                        <div class="formRight">
                            <label class="stardust-checkbox">
                                Tiêu chí
                                <input class="stardust-checkbox__input" <?= (!isset($item['tieuchi']) || $item['tieuchi'] == 1) ? 'checked="checked"' : '' ?> name="tieuchi" type="checkbox" value="1" style="display:none">
                ...
                <?php if ($GLOBAL[$com][$type]['link'] == true) { ?>
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            <input type="text" id="code_pro" name="data[link]" value="" title="Nhập link liên kết cho hình ảnh" class="tipS" />
                        </div>
                        <div class="clear"></div>
                    </div>
                <?php } ?>
                <?php if ($GLOBAL[$com][$type]['link_tmp'] == true) { ?>
                    <div class="formRow">
                        <label>Link dịch vụ: </label>
                        <div class="formRight">
                            <input type="text" id="price" name="data[link_temp]" value="<?= @$item['link_temp'] ?>" title="Nhập link_temp liên kết cho hình ảnh" class="tipS" />
                        </div>
                        <div class="clear"></div>
                    </div>
                <?php } ?>
