...
<?php
...

  {
    ...
    $str='
      ...
      <select id="id_brand" name="data[id_brand]" class="main_select">

      <option value="">Chọn menu</option>';

      foreach($stmt as $k => $v){

        $selected=($v["id"]==(int)@$item["id_brand"]) ?"selected" : "";
            ...
            <div class="<?=($GLOBAL_LEVEL1[$com][$type]['full']==true) ? 'oneOne':'colRight' ?>">
                ...
                <div class="widget mtop0">
                    ...
                    <div class="formRow">
                        ...
                        <label>Chọn danh mục menu</label>
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            ...
                            <input type="text" name="data[links]"
                                title="Nhập links" id="links" class="tipS" value="<?=@$item['links']?>" />
