                ...
                buttons: {
                    ...
                    success: {
                        ...
                        action: function() {
                            ...
                            redirect(
                                "index.html?com=baiviet&act=delete&type=<?= $_GET['type'] ?>&page=<?= $_GET['page'] ?>&listid=" +
                                listid);
            ...
            <div class="title">
                ...
                <div class="timkiem">
                    ...
                    <select class="main_select" name="data[id_list]" id="id_list"
                        onChange="window.location.href='index.html?com=<?= $_GET['com'] ?>&act=man&type=<?= $_GET['type'] ?>&id_list='+this.value">
                        ...
                        <option value="<?= $items_list[$i]['id'] ?>"
                            <?= ($_GET['id_list'] == $items_list[$i]['id']) ? 'selected' : '' ?>>
                    ...
                    <select class="main_select" name="data[id_cat]" id="id_cat"
                        onChange="window.location.href='index.html?com=<?= $_GET['com'] ?>&act=man&type=<?= $_GET['type'] ?>&id_list=<?= $_GET['id_list'] ?>&id_cat='+this.value">
                        ...
                        <option value="<?= $items_cat[$i]['id'] ?>"
                            <?= ($_GET['id_cat'] == $items_cat[$i]['id']) ? 'selected' : '' ?>>
                            <?= $items_cat[$i]['ten_vi'] ?>
                        </option>
                    ...
                    <select class="main_select" name="data[id_item]" id="id_item"
                        onChange="window.location.href='index.html?com=<?= $_GET['com'] ?>&act=man&type=<?= $_GET['type'] ?>&id_list=<?= $_GET['id_list'] ?>&id_cat=<?= $_GET['id_cat'] ?>&id_item='+this.value">
                        ...
                        <option value="<?= $items_item[$i]['id'] ?>"
                            <?= ($_GET['id_item'] == $items_item[$i]['id']) ? 'selected' : '' ?>>
                            ...
                            <tr>
                                ...
                                <td align="center" class="title_name_data">
                                    ...
                                    <a href="index.html?com=baiviet&act=edit<?php if ($_GET['id_list'] != '') echo '&id_list=' . $_GET['id_list']; ?><?php if ($_GET['id_cat'] != '') echo '&id_cat=' . $_GET['id_cat']; ?><?php if ($_GET['id_item'] != '') echo '&id_item=' . $_GET['id_item']; ?><?php if ($_GET['id_sub'] != '') echo '&id_sub=' . $_GET['id_sub']; ?><?php if ($_GET['id_product'] != '') echo '&id_product=' . $_GET['id_product']; ?>&id=<?= $items[$i]['id'] ?><?php if ($_GET['type'] != '') echo '&type=' . $_GET['type']; ?><?php if ($_GET['page'] != '') echo '&page=' . $_GET['page']; ?>"
                                        ...
                                        <img class="img-list" src="<?= _upload_baiviet . $items[$i]['photo'] ?>" alt=""
                                            width="70">
                                ...
                                <td class="title_name_data">
                                    ...
                                    <div class="add-attr mt10">
                                        ...
                                        <a style="color:#37a000;font-size:12px" title="Thuộc tính xem ngay"
                                            href="<?= $https_config . $items[$i]['type'] . '/' . $items[$i]['tenkhongdau_' . $lang] ?>"
                                            target="_blank" class="tipS SC_bold">
                                    ...
                                    <div class="attr-properties mt5">
                                        ...
                                        <a style="color:#37a000;font-size:12px"
                                            href="index.html?com=attribute&act=man&type=color&id_product=<?= $items[$i]['id'] ?>&page=1&act_baiviet=<?= $_GET["act"] ?>&page_baiviet=<?= $_GET["page"] ?>"
                                            class="tipS SC_bold">
                                ...
                                <td align="center" class="title_name_data">
                                    ...
                                    <select select-w data-view-id data-list-<?= $items[$i]['id'] ?>
                                        data-product="<?= $items[$i]['id'] ?>" class="main_select select-w"
                                        name="select_list" id="list">
                                        ...
                                        <option
                                            <?php if ($v['id'] == $items[$i]['id_list']) echo 'selected="selected"' ?>
                                            value="<?= $v['id'] ?>"><?= $v["ten_vi"] ?></option>
                                ...
                                <td align="center" class="title_name_data">
                                    ...
                                    <select select-w data-view-cat data-cat-<?= $items[$i]['id'] ?>
                                        data-product="<?= $items[$i]['id'] ?>" class="main_select select-w"
                                        name="select_cat" id="cat">
                                        ...
                                        <option
                                            <?php if ($v['id'] == $items[$i]['id_cat']) echo 'selected="selected"' ?>
                                            value="<?= $v['id'] ?>"><?= $v["ten_vi"] ?></option>
                                ...
                                <td align="center" class="title_name_data">
                                    ...
                                    <select select-w data-view-item data-item-<?= $items[$i]['id'] ?>
                                        data-product="<?= $items[$i]['id'] ?>" style="margin-top:10px"
                                        class="main_select select-w" name="select_item" id="item">
                                        ...
                                        <option
                                            <?php if ($v['id'] == $items[$i]['id_item']) echo 'selected="selected"' ?>
                                            value="<?= $v['id'] ?>"><?= $v["ten_vi"] ?></option>
                                ...
                                <td align="center">
                                    ...
                                    <select name="status" <?php if ($items[$i]['id_loai'] == 0) {
                                                                    ...
                                                                    } ?> data-table="baiviet" data-type="post"
                                        data-id="<?= $items[$i]['id'] ?>" class="main_select js-update-status">

                                        <?php foreach ($config['id_loai'] as $key => $value) { ?>

                                        <option value="<?= $key ?>"
                                            <?= (@$items[$i]['id_loai'] == $key) ? 'selected' : '' ?>>
                                ...
                                <td class="sortCol" align="center">
                                    ...
                                    <label class="stardust-checkbox checkOnOff">
                                        ...
                                        <input class="checker-status" data-table="<?= $com ?>" data-type="<?= $type ?>"
                                            data-id="<?= $items[$i]['id'] ?>"
                                            <?php if (in_array($k1, $arr_status)) echo 'checked'; ?>
                                            name="status<?= $items[$i]['id'] ?>[]" type="checkbox" value="<?= $k1 ?>"
                                            style="display:none">
                                ...
                                <td align="center">
                                    ...
                                    <label class="stardust-checkbox checkOnOff">
                                        ...
                                        <input class="stardust-checkbox__input" data-id="<?= $items[$i]['id'] ?>"
                                            data-table="table_baiviet" data-type="<?= $key ?>"
                                            rel="<?= $items[$i][$key] ?>"
                                            <?php if ($items[$i][$key] == 1) echo 'checked'; ?> name="onOff"
                                ...
                                <td class="actBtns">
                                    ...
                                    <a class="text-danger" data-product="<?= $items[$i]['id'] ?>"
                                        data-com="<?= $_GET['com'] ?>" data-act="delete" data-tbl=""
                                        data-type="<?= $_GET['type'] ?>" data-page="<?= $_GET['page'] ?>"
                                        href="javascript:" data-js-delete title="" class="smallButton tipS"
                                        original-title="Xóa ">
