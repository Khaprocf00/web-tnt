            ...
            <div class="<?= ($table['full'] == true) ? 'oneOne' : 'colLeft' ?>">
                ...
                <div class="widget mtop0">
                    ...
                    <?php if ($table['numb'] == true) { ?>
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                ...
                                <input type="text" name="data[numb]" title="Nhập con số" id="numb" class="tipS" value="<?= @$item['numb'] ?>" />
                    ...
                    <?php foreach ($config['lang'] as $k => $v) { ?>
                        ...
                        <?php if ($table['mota_km'] == true) { ?>
                            ...
                            <div class="formRow lang_hidden lang_<?= $k ?> <?= ($k == 'vi') ? 'active' : '' ?>">
                                ...
                                <div class="ck_editor">
                                    ...
                                    <textarea title="Nhập mô tả [<?= $v ?>]. " data-height="400" id="mota_km_<?= $k ?>" <?= ($table['mota_km-ckeditor'] == true) ? 'class="ck_editors"' : 'rows="8"' ?> name="data[mota_km_<?= $k ?>]"><?= @$item['mota_km_' . $k] ?></textarea>
                        ...
                        <?php if ($table['thongtin'] == true) { ?>

                            <div class="formRow lang_hidden lang_<?= $k ?> <?= ($k == 'vi') ? 'active' : '' ?>">

                                <label>Quy định [<?= $v ?>]</label>

                                <div class="ck_editor">

                                    <textarea title="Nhập mô tả bảo hành [<?= $v ?>]. " data-height="400" id="thongtin_<?= $k ?>" <?= ($table['thongtin-ckeditor'] == true) ? 'class="ck_editors"' : 'rows="8"' ?> name="data[thongtin_<?= $k ?>]"><?= @$item['thongtin_' . $k] ?></textarea>
                        ...
                        <?php if ($table['huongdansudung'] == true) { ?>
                            ...
                            <div class="formRow lang_hidden lang_<?= $k ?> <?= ($k == 'vi') ? 'active' : '' ?>">
                                ...
                                <div class="ck_editor">
                                    ...
                                    <textarea title="Nhập hướng dẫn sử dụng [<?= $v ?>]. " data-height="400" id="huongdansudung_<?= $k ?>" <?= ($table['huongdansudung-ckeditor'] == true) ? 'class="ck_editors"' : 'rows="8"' ?> name="data[huongdansudung_<?= $k ?>]"><?= @$item['huongdansudung_' . $k] ?></textarea>
            ...
            <div class="<?= ($table['full'] == true) ? 'oneOne' : 'colRight' ?>">
                ...
                <div class="widget mtop0">
                    ...
                    <?php if ($GLOBAL[$com][$type]['dungtich']) { ?>
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                ...
                                <input type="text" name="data[dungtich]" title="Nhập dung tích" id="dungtich" class="tipS" value="<?= @$item['dungtich'] ?>" />
                    ...
                    <?php if ($GLOBAL[$com][$type]['trangthai']) { ?>
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                ...
                                <input type="text" name="data[trangthai]" title="Nhập trạng thái" id="trangthai" class="tipS" value="<?= @$item['trangthai'] ?>" />
                    ...
                    <?php if ($table['soluongban'] == true) { ?>
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                ...
                                <input type="text" name="data[soluongban]" title="Nhập giá bán" id="soluongban" class="conso tipS" value="<?= @$item['soluongban'] ?>" />
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                ...
                                <select name="data[id_loai]" id="id_loai" class="main_select">
                                    ...
                                    <option value="1" <?= (@$item['id_loai'] == 1) ? 'selected' : '' ?>>Đang thi công

                                    </option>

                                    <option value="2" <?= (@$item['id_loai'] == 2) ? 'selected' : '' ?>>Đã thi công
                    ...
                    if ($GLOBAL[$com][$type]['tags'] == true) {
                        $data_tags = $db->rawQuery("select id,ten_vi from #_tags where type=? and hienthi=1 order by stt asc,id desc", array('bo-mon'));
                        ...
                        <?php if ($_GET['act'] == 'edit' || $_GET['act'] == 'copy') { ?>
                            ...
                            <div class="formRow">
                                ...
                                <div class="formRight">
                                    ...
                                    <div class="mt10"><img style="max-width:100%" src="<?= _upload_baiviet . $item['photo1'] ?>" alt="NO PHOTO" width="<?= $table['img-width'] ?>" height="<?= $table['img-height'] ?>" /></div>
