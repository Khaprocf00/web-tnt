        ...
        $.confirm({
            ...
            buttons: {
                success: {
                    ...
                    action: function() {
                        redirect(
                            "index.html?com=baiviet&act=delete_cat&tbl=<?=$_GET['tbl']?>&type=<?=$_GET['type']?>&page=<?=$_GET['page']?>&listid=" +
                            listid);
                    }
                },
                cancel: {
                        ...
                        <tr>
                            ...
                            <td class="tb_data_small">
                                <select class="main_select" name="data[id_list]" id="id_list"
                                    onChange="window.location.href='index.html?com=<?=$_GET['com']?>&act=man_cat&tbl=cat&type=<?=$_GET['type']?>&id_list='+this.value">
                        ...
                        foreach($GLOBAL_LEVEL2[$com][$type]['check_cat'] as $key => $value){?>
                            <td align="center">
                                <label class="stardust-checkbox checkOnOff">
                                    <input class="stardust-checkbox__input" data-id="<?=$items[$i]['id']?>"
                                        data-table="table_baiviet_cat" data-type="<?=$key?>" rel="<?=$items[$i][$key]?>"
                            ...
                            <td class="actBtns">
                                <a class="text-primary"
                                    href="index.html?com=baiviet&act=edit_cat&tbl=<?=$_GET['tbl']?>&id_list=<?=$items[$i]['id_list']?>&id=<?=$items[$i]['id']?><?php if($_GET['type']!='') echo'&type='. $_GET['type'];?><?php if($_GET['page']!='') echo'&page='. $_GET['page'];?>"
