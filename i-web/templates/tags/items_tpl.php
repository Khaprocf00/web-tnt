...
$(document).ready(function() {
    ...
    $('.box-search button').click(function(event) {
        ...
        window.location.href = "index.html?com=tags&act=man&type=<?=$_GET['type']?>&keyword=" +
                ...
                buttons: {
                    ...
                    success: {
                        ...
                        action: function(){
                           ...
                           redirect("index.html?com=tags&act=delete&type=<?=$_GET['type']?>&page=<?=$_GET['page']?>&listid=" + listid);
        ...
        <div class="bc">
            ...
            <ul id="breadcrumbs" class="breadcrumbs">
                ...
                <li><a
                        ...
                        href="index.html?com=tags&act=man<?php if($_GET['id_list']!='') echo'&id_list='. $_GET['id_list'];?><?php if($_GET['id_cat']!='') echo'&id_cat='. $_GET['id_cat'];?><?php if($_GET['id_item']!='') echo'&id_item='. $_GET['id_item'];?><?php if($_GET['id_sub']!='') echo'&id_sub='. $_GET['id_sub'];?><?php if($_GET['type']!='') echo'&type='. $_GET['type'];?><?php if($_GET['page']!='') echo'&page='. $_GET['page'];?>"><span><?=$GLOBAL[$com][$type]['title']?></span></a>
            ...
            <div class="box-admin" style="display:flex; align-items:center;">
                ...
                <div class="box-action">
                    ...
                    <a class="btn btn-sm bg-gradient-primary text-white"
                        ...
                        href="index.html?com=tags&act=add<?php if($_GET['id_list']!='') echo'&id_list='. $_GET['id_list'];?><?php if($_GET['id_cat']!='') echo'&id_cat='. $_GET['id_cat'];?><?php if($_GET['id_item']!='') echo'&id_item='. $_GET['id_item'];?><?php if($_GET['id_sub']!='') echo'&id_sub='. $_GET['id_sub'];?><?php if($_GET['id_product']!='') echo'&id_product='. $_GET['id_product'];?><?php if($_GET['type']!='') echo'&type='. $_GET['type'];?><?php if($_GET['page']!='') echo'&page='. $_GET['page'];?>">
                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <?php if($GLOBAL[$com][$type]['list']==true){?>
                                ...
                                <td align="center" style="width:10%" align="left">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align="center" class="title_name_data">
                                ...
                                <a href="index.html?com=tags&act=edit<?php if($_GET['id_list']!='') echo'&id_list='. $_GET['id_list'];?><?php if($_GET['id_cat']!='') echo'&id_cat='. $_GET['id_cat'];?><?php if($_GET['id_item']!='') echo'&id_item='. $_GET['id_item'];?><?php if($_GET['id_sub']!='') echo'&id_sub='. $_GET['id_sub'];?><?php if($_GET['id_product']!='') echo'&id_product='. $_GET['id_product'];?>&id=<?=$items[$i]['id']?><?php if($_GET['type']!='') echo'&type='. $_GET['type'];?><?php if($_GET['page']!='') echo'&page='. $_GET['page'];?>"
                            ...
                            <td class="title_name_data">
                                ...
                                <div class="add-attr mt10">
                                    ...
                                    <a style="color:#37a000;font-size:12px" title="Thuộc tính chỉnh sửa"
                                        ...
                                        href="index.html?com=tags&act=edit<?php if($_GET['id_list']!='') echo'&id_list='. $_GET['id_list'];?><?php if($_GET['id_cat']!='') echo'&id_cat='. $_GET['id_cat'];?><?php if($_GET['id_item']!='') echo'&id_item='. $_GET['id_item'];?><?php if($_GET['id_sub']!='') echo'&id_sub='. $_GET['id_sub'];?><?php if($_GET['id_product']!='') echo'&id_product='. $_GET['id_product'];?>&id=<?=$items[$i]['id']?><?php if($_GET['type']!='') echo'&type='. $_GET['type'];?><?php if($_GET['page']!='') echo'&page='. $_GET['page'];?>"
                                ...
                                <?php /* <div class="attr-properties mt5">

                                    <a style="color:#37a000;font-size:12px ;margin: 0px 5px 5px;" title="Thuộc tính copy"

                                        href="index.html?com=tags&act=copy&id_copy=<?=$items[$i]['id']?><?php if($_GET['type']!='') echo'&type='. $_GET['type'];?><?php if($_GET['page']!='') echo'&page='. $_GET['page'];?>"
                                    ...
                                    <a style="color:#D33331;font-size:12px" title="Thuộc tính xóa"

                                        href="index.html?com=tags&act=delete&id=<?=$items[$i]['id']?><?php if($_GET['id_product']!='') echo'&id_product='. $_GET['id_product'];?><?php if($_GET['type']!='') echo'&type='. $_GET['type'];?><?php if($_GET['page']!='') echo'&page='. $_GET['page'];?>"
                            ...
                            <?php if($GLOBAL[$com][$type]['list']==true){?>
                                <td align="center" class="title_name_data">
                                        ...
                                        $result=$db->rawQueryOne("select ten_vi from table_tags_list where id='".$items[$i]['id_list']."' and type=?",array($type));
                            ...
                            <?php if($GLOBAL[$com][$type]['cat']==true){?>
                                <td align="center" class="title_name_data">
                                    ...
                                    <?php /*
                                        ...
                                        $result=$db->rawQueryOne("select ten_vi from table_tags_cat where id='".$items[$i]['id_cat']."' and type=?",array($type));

                                        echo @$result['ten_vi'];

                                    */?>

                                    <select select-w data-view-cat data-cat-<?=$items[$i]['id']?> data-product="<?=$items[$i]['id']?>" style="margin-top:10px" class="main_select select-w" name="select_cat" id="cat">
                            ...
                            <?php if($GLOBAL[$com][$type]['item']==true){?>
                                <td align="center" class="title_name_data">
                                    ...
                                    <?php /*
                                        ...
                                        $result=$db->rawQueryOne("select ten_vi from table_tags_item where id='".$items[$i]['id_item']."' and type=?",array($type));

                                        echo @$result['ten_vi'];

                                    */?>
                                        <select select-w data-view-item data-item-<?=$items[$i]['id']?> data-product="<?=$items[$i]['id']?>" style="margin-top:10px" class="main_select select-w" name="select_item" id="item">
                            ...
                            <td align="center" align="center">
                                ...
                                <a data-push="<?=$items[$i]['id']?>"
                                    ...
                                    data-type="<?=$items[$i]['type']?>" data-val2="table_tags"
                            ...
                            <td style="width:90px" align="center">
                                ...
                                <select name="status"
                                 ...
                                 data-table="tags" data-type="post" data-id="<?=$items[$i]['id']?>" class="main_select js-update-status">
                            ...
                            <td align="center">
                                ...
                                <label class="stardust-checkbox checkOnOff">
                                    ...
                                    <input class="stardust-checkbox__input" data-id="<?=$items[$i]['id']?>"
                                        ...
                                        data-table="table_tags" data-type="<?=$key?>" rel="<?=$items[$i][$key]?>"
