...
<form name="supplier" class="form form-validate"
    ...
    <div class="<?=($GLOBAL[$com][$type]['full']==true) ? 'oneOne':'colLeft' ?>">
        <div class="widget mtop0">
            ...
            <?php if($GLOBAL[$com][$type]['slogan']){ ?>
            <div class="formRow lang_hidden lang_<?=$k?> <?= ($k == 'vi') ? 'active': '' ?>">
                <label>Slogan [<?=$v?>]</label>
                <div class="formRight">
                    <input type="text" name="data[slogan1_<?=$k?>]" title="Nhập slogan" id="slogan1_<?=$k?>"
                        class="tipS" value="<?=@$item['slogan1_'.$k]?>" />
                </div>
                <div class="clear"></div>
            </div>
            <?php }?>
            <?php /* if($GLOBAL[$com][$type]['slogan']){ ?>
            <div class="formRow lang_hidden lang_<?=$k?> <?= ($k == 'vi') ? 'active': '' ?>">
                <label>Slogan2 [<?=$v?>]</label>
                <div class="formRight">
                    <input type="text" name="data[slogan2_<?=$k?>]" title="Nhập slogan" id="slogan2_<?=$k?>"
                        class="tipS" value="<?=@$item['slogan2_'.$k]?>" />
                </div>
                <div class="clear"></div>
            </div>
            <?php } */ ?>
