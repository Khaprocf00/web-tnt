<?php
    ...
    $author_post = $db->rawQuery("select ten_$lang as ten,id,id_list,tenkhongdau_$lang as tenkhongdau,type,luotxem,ngaytao,ngaysua from #_baiviet where hienthi=1 and type in ('tin-tuc','tuyen-dung','chinh-sach') and id_tacgia=? order by stt asc,id asc limit {$offset},{$limit}",array($id_tacgia));
