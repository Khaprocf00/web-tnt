...
var _URL = "<?= ($com == 'tim-kiem') ? $func->getCurrentPageURL_SEARCH() : $func->getCurrentPageURL() ?>";
</script>
...
$js->setJs("./assets/js/scroller.js");
...
<script>
const questions = document.querySelectorAll('.questions ul li .question');
