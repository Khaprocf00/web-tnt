        ...
        <div class="wrapper-right__one">
            ...
            <ul class="wrapper-right__category">
                ...
                <li class="wrapper-right__category-item">
                    <a href="<?= $func->getUrl($value) ?>" aria-label="<?= $value["ten"] ?>"
                        title="<?= $value["ten"] ?>" class="wrapper-featured__news-link" role="link" rel="dofollow">
        ...
        <div class="wrapper-right__two">
            ...
            <ul class="wrapper-right__list">
                ...
                <li class="wrapper-featured__news-item mb10 wrapper-right__list-box pt10">
                    ...
                    <a href="<?= $value["type"] ?>/<?= $value["tenkhongdau"] ?>" aria-label="<?= $value["ten_$lang"] ?>"
                        title="<?= $value["ten_$lang"] ?>" class="wrapper-featured__news-link" role="link"
                        rel="dofollow">
        ...
        <div class="wrapper-right__two mt20 d-none-m d-none-tablet">
            ...
            <ul class="wrapper-right__list">
                ...
                <li class="wrapper-featured__news-item mb10 wrapper-right__list-box pt10">
                    ...
                    <a href="<?= $func->getUrl($value) ?>" aria-label="<?= $value["ten_$lang"] ?>"
                        title="<?= $value["ten_$lang"] ?>" class="wrapper-featured__news-link" role="link"
                        rel="dofollow">
