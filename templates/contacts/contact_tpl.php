...
<section class="starceiling-banner__allpage p-relative"
...
<section class="mt30 mb30 mt-m-20 mb-m-20">
                        ...
                        <div class="contact__top-img">
                            ...
                            <span class="d-block hover-left ratio-img ratio-cover" img-width="570" img-height="300">
                                ...
                                <img class="ratio-img__content img-scale" src="./assets/images/loading_image.svg"
                                    data-src="<?=_upload_hinhanh_l.$ha_lienhe->photo?>" alt="Hình ảnh liên hệ"
                                    <?=$func->errorImg()?>>
                                            ...
                                            <div class="box">
                                                ...
                                                <div class="row d-flex">
                                                    ...
                                                    <div class="item col-7">
                                                        ...
                                                        <input type="text" name="data[capcha]" class="capcha css-input"
                                                            id="contactCapcha" required placeholder="Nhập mã bảo mật">
                                    ...
                                    <div class="item col-6 w-100-m">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <button type="button" id="submit-contact"
                                                class="li-btn-3"><?=_guithongtin?></button>
