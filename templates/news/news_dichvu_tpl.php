...
$row_tacgia = $db->rawQueryOne("select ten_$lang as ten,noidung_$lang ,tenkhongdau_$lang as tenkhongdau,photo,mota_$lang as mota,link_facebook,link_instagram,link_twitter,link_zalo,type,job_$lang as job from #_baiviet where hienthi=1 and type=? and id=? limit 0,1", array('tac-gia', $row_detail["id_tacgia"]));
?>
<div id="fb-root"></div>
...
<section class="wrapper-news__detail mt30 mt-m-20">
    <div class="grid wide">
        <div class="row">
            <div class="col l-12 m-12 c-12 d-flex">
                <div class=" col l-9 m-9 c-9 content-detail mt20 clearfix">
                    <div class="other-news-detail font-detail">
                        <div class="detail">
                            ...
                            <div class="img-blog-main-detial">

                                <?= $func->getHrefImg($row_detail) ?>
                            </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-5 mr20">
                            <div class="form__input d-flex">
                                ...
                                <input type="text" name="fullname" type="text" class="input" id="hoten" size="50"
                                    value="" placeholder="Vui lòng nhập họ và tên...." fdprocessedid="lxt19n">
                            </div>
                            <div class="form__input d-flex align-items-center">
                                ...
                                <input name="phone" type="text" class="input" id="phone" size="50" value=""
                        ...
                        <div class="col-6">
                            <div class="form__input textarea">
                                <textarea name="content" value="" placeholder="Tên sản phẩm..." fdprocessedid="my876"
                                    rows="8"></textarea>
                            </div>
                        </div>
                    </div>
                    <div style="  padding-left: 37px;">
                        <button id="submit_register" type="button" class="res--btn--booking js--booking center"
                            fdprocessedid="40qu7q"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="19"
...
<style>
.img-blog-main-detial a {
    aspect-ratio: auto 2/1;
}

.img-blog-main-detial .cubic-img:hover>img {
