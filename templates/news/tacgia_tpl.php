<?php
    ...
    $author_post = $db->rawQuery("select ten_$lang as ten,id,id_list,tenkhongdau_$lang as tenkhongdau,type,luotxem,ngaytao,ngaysua from #_baiviet where hienthi=1 and type in ('san-pham','du-an','tin-tuc','dich-vu','chinh-sach') and id_tacgia=? order by stt asc,id asc limit 0,4",array($row_detail["id"]));
...
<section class="wrappers-author mt20">
    ...
    <div class="grid wide">
        ...
        ?>
            ...
            <div class="<?=$col?>">
                ...
                <?php /* <div class="breadcumb breadcumb--detail mt20 d-none-m">
                    <?=$str_breadcrumbs?>
                </div> */ ?>
                ...
                <div class="content-detail mt20 mb20 clearfix">
                    ...
                    <div class="other-news-detail font-detail">
                        ...
                        <div class="wrapper-author__post-aside mt20">

                            <div class="row" id="load_post_author">        
                              ...
                              <?php foreach($author_post as $key=>$value){
                                ...
                                <div class="col l-6 m-6 c-12 mb20 mb-m-8">
                                
                                    <div class='wrapper-author__post'>
                        ...
                        <div class="wrapper-author__post-message">
                            ...
                            <button data-offset="4" data-limit="4" id="viewmore_author">Xem Thêm</button>
...
<script>
    ...
    $('#viewmore_author').click(function(){
        ...
        $.ajax({
            ...
            data:{ offset:offset,limit:limit,id:id},
            ...
            success:function(res){
                ...
                if(res.status==200){
                    ...
                    $('#load_post_author').append(res.html);

                    var numberOffset = Number(offset) + 4;
