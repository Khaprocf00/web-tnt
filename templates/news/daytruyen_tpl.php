                ...
                <div class="col l-3 m-4 c-6 mb20 mb-t-16 mb-m-8 d-flex flex-column">
                    ...
                    <div class="facemask-line__box d-flex flex-column flex-cl-1">
                        ...
                        <div class="facemask-line__box-img">
                            ...
                            <a href="<?=_upload_baiviet_l.$value["photo"]?>" data-fancybox="facemask-line-img<?=$key?>"
                                title="<?=$value["ten"]?>" role="button"
                                class="d-block ratio-cover hover-left ratio-img cubic-img"
                                aria-label="<?=$value["ten"]?>" img-width="270" img-height="270">

                                <img class="ratio-img__content img-scale" width="270" height="270"
                                    data-src="<?=_upload_baiviet_l.$value["photo"]?>" src="<?=$imgDefault?>"
                                    alt="<?=$value["ten"]?>">
                            ...
                            <div class="hidden">
                                ...
                                <a href="<?=_upload_baiviet_l.$vpt["photo"]?>"
                        ...
                        <div class="facemask-line__box-detail d-flex flex-column flex-cl-1">
                            ...
                            <h3 class="facemask-line__box-detail-title line-2 mg0 flex-cl-1">
                                ...
                                <a href="javascript:void(0)" title="<?=$value["ten_$lang"]?>"
                                    aria-label="<?=$value["ten_$lang"]?>" role="button"><?=$value["ten_$lang"]?></a>
